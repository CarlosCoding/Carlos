...
function go () {
  typish('#typer')
    ...
    .type('今天陆先森教你写代码可好呀？', '<span class="note">')
    .type('0', '<br>')
    .type('00', '<span class="blank">')
    .wait(10)
    .type('Waiting...', '<span class="note">')
    .wait(10)
    .type('么么哒~o(*≧▽≦)Betty_Zpy', '<span class="note">', 0)
    .wait(10)
    .then(() => {
      memeda()
    })
  ...
  // 第一个options
    ...
    .type(':', '<span class="blue">')
    .type('0', '<span class="blank">')
    .type("'Carlos'", '<span class="green">')
    .wait(15)
    .del(8)
    .type("'陆旭辉'", '<span class="green">')
    .type(',', '<span class="gray">')
    .type('0', '<br>')
    // 珊珊
    .type('0000', '<span class="blank">')
